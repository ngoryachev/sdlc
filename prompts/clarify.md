...
- `branch`: 2–5 English words, lowercase, hyphen-separated, naming the change for a git branch, e.g. `traps-preset` or `play-lines-to-end`. Always English, whatever the language of the request.
